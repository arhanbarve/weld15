...
| Closets | 7.5 x 7.5 | 56.25 | not mentioned |
| Bedroom B | 16 x 10 | 160 | 10 x 16 |
| **the resident's five rooms** | | **800** | |
| **With hall and closets** | | **984.5** | 246.13 per person for four |
...
65 sq ft light, and no mention of the closets -- which is the same drift that let
"54 x 151" survive across three artifacts.
...
```
   ...
   |-------------------------------------------|
   |   BATHROOM      8 x 7.5    facade         |
   |   + closets   7.5 x 7.5    interior       |
   |-------------------------------------------|
