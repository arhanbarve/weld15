...
export function CameraRig() {
   ...
   * empty. So leaving is a cut, on purpose -- though since P10 there is no button that
   * leaves first person mid-stride any more: standing is a property of stage 5, and the
   * only way `walking` flips is an actual stage change (`[`, a link, a reset), which is
   * exactly the case `[stage, walking]` already un-settles for.
   */
  useEffect(() => {
