...
/**
 * Measured ceiling with real margin: both step 0 sessions (28 and 56 poses) settled in
 * 228-249s. 5 minutes is comfortably above either, short of "never" if a real regression
 * (e.g. a batch's idle-frame check never firing) reintroduces the timeout-every-batch bug
 * this phase's own history already found once (docs/phases/P13-PRELOAD.md's BATCH_TIMEOUT_MS
 * comment).
 */
const PRELOAD_DEADLINE_MS = 300_000;
